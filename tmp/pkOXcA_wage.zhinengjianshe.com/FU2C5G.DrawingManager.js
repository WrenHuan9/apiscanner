...
(function() {
    ...
    DrawingManager.prototype.openEdit = function () {
        this.enableEditingData.enableEditing()
    };
    ...
    DrawingManager.prototype._bindCircle = function () {
        ...
        var moveAction = function (e) {
            ...
            tip_label = new BMap.Label('半径：' + radius + '米<br>点击完成绘制', {
        ...
        var endAction = function (e) {
            ...
            radiusWindow.addEventListener('radiuschange', function (e) {
                ...
                console.log(centerPoint, radius,'111');
        ...
        var mousemoveAction = function (e) {
            ...
            tip_label = new BMap.Label('鼠标点击确认中心点，拖拽确认半径', {
                position: e.point, // 指定文本标注所在的地理位置
                offset: new BMap.Size(10, 10) // 设置文本偏移量
            });
            tip_label.setStyle(me.labelOptions);
    ...
    DrawingManager.prototype._bindPolylineOrPolygon = function () {
        ...
        var startAction = function (e) {
            if (e.button == 1 || e.button == 0) {
                ...
                if (!isBinded) {
                    ...
                    // mask.addEventListener('contextmenu', contextmenuAction);
                }
            } else if(e.button == 2 && points.length >= 3){
              var point = e.point;
              if (match) {
                  point = match;
              }
        ...
        var moveAction = function (e) {
            ...
            if(drawPoint.length<=3){
              tip_label = new BMap.Label('左击绘制下一个点', {
                  position: e.point, // 指定文本标注所在的地理位置
                  offset: new BMap.Size(10, 10) // 设置文本偏移量
              });
            }else{
              tip_label = new BMap.Label('左击绘制下一个点，右击完成绘制', {
                position: e.point, // 指定文本标注所在的地理位置
                offset: new BMap.Size(10, 10) // 设置文本偏移量
            });
            }
        ...
        var contextmenuAction = function (e) {
            ...
            mask.removeEventListener('mousemove', moveAction);
            mask.removeEventListener('mousemove', mousemoveAction);
            mask.removeEventListener('contextmenu', contextmenuAction);
            points.pop();
        ...
        var mousemoveAction = function (e) {
            ...
            tip_label = new BMap.Label('单击鼠标左键确认起点', {
                position: e.point, // 指定文本标注所在的地理位置
                offset: new BMap.Size(10, 10) // 设置文本偏移量
            });
            tip_label.setStyle(me.labelOptions);
    ...
    Mask.prototype._bind = function () {
         ...
         */
        var events = ['click', 'mousedown', 'mousemove', 'mouseup', 'dblclick', 'contextmenu'],
            index = events.length;
        while (index--) {
